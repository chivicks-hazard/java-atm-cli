...
This is a project to simulate the experience of using an ATM machine via the console. This is built using Java and MySQL but it can work with any relational database once you install the dependency.
